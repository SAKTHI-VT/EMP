        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="input-group">
                        ...
                        <input class="input--style-1" placeholder="Date of Birth">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Role" name="dept" required="required">
                        </div>
                        ...
                        <input class="input--style-1" placeholder="Employee Photo">
